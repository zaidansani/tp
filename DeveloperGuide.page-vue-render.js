...
with(this){return _c('h2',{attrs:{"id":"proposed-features"}},[_v("Proposed features"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#proposed-features","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Steps 1 to 6 will similarly be implemented for the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Appointment")]),_v(" data. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedAppointmentBook")]),_v(" will\nbe initialized with the initial appointment book state, and the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(" pointing to that\nsingle appointment book state. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("commit")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undo")]),_v(", and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("redo")]),_v(" operations for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedAppointmentBook")]),_v("\nwill be implemented in the same way as the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedAddressBook")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"design-considerations-15"}},[_v("Design considerations:"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#design-considerations-15","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Keep it brief (~1 page)")]),_v(" "),_c('li',[_v("Explain the difficulty level, challenges faced, effort required, and achievements of the project.")]),_v(" "),_c('li',[_v("If a significant part (e.g., more than 5%) of the effort was saved through reuse, mention what you reused and how it affected the effort e.g., the feature X is implemented using library Foo -- our work on adapting Foo to our product is contained in class FooAdapter.java.")]),_v(" "),_c('li',[_v("Use AB3 as a reference point e.g., you can explain that while AB3 deals with only one entity type, your project was harder because it deals with multiple entity types.")])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Wed, 30 Oct 2024, 13:43:41 GMT+8]")])])])}
}];
